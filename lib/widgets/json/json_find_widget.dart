...
class CodeFindPanelView extends StatelessWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize => Size(
      ...
      controller.value == null
          ? 0
          : ((controller.value!.replaceMode ? _kDefaultReplacePanelHeight : _kDefaultFindPanelHeight) +
              margin.vertical));
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: decoration.copyWith(
            contentPadding: (decoration.contentPadding ?? EdgeInsets.zero).add(EdgeInsets.only(right: iconsWidth))),
